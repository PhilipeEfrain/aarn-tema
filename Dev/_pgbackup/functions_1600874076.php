...
function aarn_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'associados01_requerimentos', array(
        'type' => 'theme_mod',
        'default' => '<div class="grid_4 text-center"> <i class="fa fa-file-o"></i> </div><h4 class="text-center pad10">Requerimento</h4>',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'associados01_requerimentos', array(
        'label' => __( 'Requerimento', 'aarn' ),
        'type' => 'text',
        'section' => 'associados01'
    ));

    $wp_customize->add_setting( 'associados01_requerimento_link', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'associados01_requerimento_link', array(
        'label' => __( 'Link para Requerimento', 'aarn' ),
        'type' => 'url',
        'section' => 'associados01'
    ));

    $wp_customize->add_setting( 'associados01_anuidade', array(
        'type' => 'theme_mod',
        'default' => '<div class="grid_4 text-center"> <i class="fa fa-calendar"></i> </div><h4 class="text-center pad10">Anuidade</h4>',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'associados01_anuidade', array(
        'label' => __( 'Anuidade', 'aarn' ),
        'type' => 'text',
        'section' => 'associados01'
    ));

    $wp_customize->add_setting( 'associados01_anuidade_link', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'associados01_anuidade_link', array(
        'label' => __( 'Link para Anuidade', 'aarn' ),
        'type' => 'url',
        'section' => 'associados01'
    ));
