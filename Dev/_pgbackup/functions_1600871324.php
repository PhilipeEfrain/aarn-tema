...
function aarn_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'associados_texto_02', array(
        'type' => 'theme_mod',
    ...
    $wp_customize->add_control( 'associados_texto_02', array(
