...
function aarn_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'associados', array(
        'title' => __( 'Associados', 'aarn' )
    ));
    ...
    $wp_customize->add_setting( 'associados_texto_', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'associados_texto_', array(
        'label' => __( 'Texto', 'aarn' ),
        'type' => 'textarea',
        'section' => 'associados'
    ));
