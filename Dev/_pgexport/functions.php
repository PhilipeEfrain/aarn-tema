...
function aarn_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'chamada_principal_nota', array(
        'type' => 'theme_mod',
        'default' => __( 'Copy & paste content blocks', 'aarn' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'chamada_principal_nota', array(
        'label' => __( 'Título Nota', 'aarn' ),
        'type' => 'text',
        'section' => 'chamada_principal'
    ));

    $wp_customize->add_setting( 'chamada_principal_nota_texto', array(
        'type' => 'theme_mod',
        'default' => __( 'Helvetica mustache squid plaid meh Brooklyn hashtag, retro chillwave YOLO four loko photo booth. Brooklyn kale chips, seitan hella 3 wolf moon slow-carb paleo.', 'aarn' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'chamada_principal_nota_texto', array(
        'label' => __( 'Nota Texto', 'aarn' ),
        'type' => 'textarea',
        'section' => 'chamada_principal'
    ));
...
if ( ! function_exists( 'aarn_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'aarn-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', false, null, true);
    ...
    wp_enqueue_script( 'aarn-bootstrap-1', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', false, null, true);

    wp_deregister_script( 'aarn-animator' );
    wp_enqueue_script( 'aarn-animator', 'https://cdn.rawgit.com/MhdAljuboori/6ea3a3fa48248e3a132a/raw/animator.js', false, null, true);

    wp_deregister_script( 'aarn-jquerywaypoints' );
    wp_enqueue_script( 'aarn-jquerywaypoints', 'https://cdnjs.cloudflare.com/ajax/libs/waypoints/4.0.0/jquery.waypoints.min.js', false, null, true);

    wp_deregister_script( 'aarn-ieviewportbugworkaround' );
    wp_enqueue_script( 'aarn-ieviewportbugworkaround', get_template_directory_uri() . '/assets/js/ie10-viewport-bug-workaround.js', false, null, true);
    ...
    wp_deregister_style( 'aarn-animate' );
    wp_enqueue_style( 'aarn-animate', 'https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.4.0/animate.min.css', false, null, 'all');

    wp_deregister_style( 'aarn-fontawesome-1' );
    wp_enqueue_style( 'aarn-fontawesome-1', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', false, null, 'all');
